    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.tradingview.com https://*.tradingview-widget.com https://challenges.cloudflare.com",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: https: blob:",
              "font-src 'self' https://fonts.gstatic.com",
              "connect-src 'self' https://*.sentry.io wss://fstream.binance.com wss://stream.bybit.com wss://ws.okx.com:8443 wss://ws.bitget.com wss://www.deribit.com wss://api.hbdm.com wss://backend-arbitrum.gains.trade wss://indexer.dydx.trade wss://api-pub.bitfinex.com wss://prices.info-hub.io https://prices.info-hub.io wss://api.hyperliquid.xyz https://api.hyperliquid.xyz https://*.tradingview.com https://*.tradingview-widget.com wss://*.tradingview.com wss://*.tradingview-widget.com https://challenges.cloudflare.com",
              "frame-src https://*.tradingview.com https://*.tradingview-widget.com https://challenges.cloudflare.com",
              "child-src https://*.tradingview.com https://*.tradingview-widget.com https://challenges.cloudflare.com",
