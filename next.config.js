    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.tradingview.com https://*.tradingview-widget.com",
              ...
              "child-src https://*.tradingview.com https://*.tradingview-widget.com",
