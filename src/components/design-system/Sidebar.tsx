...
const DEFAULT_SECTIONS: SidebarSection[] = [
  ...
  { id: 'risk', label: 'Risk & Liquidations', items: [
    ...
    { href: '/watch',                    label: 'Wallet Alerts',   color: ACC,  icon: I.watch },
  ...
  { id: 'onchain', label: 'On-Chain & Flows', items: [
    ...
    { href: '/bridge-flows',      label: 'Bridge Flows',   color: ACC,  icon: I.signal },
  ...
  { id: 'tools', label: 'Tools', items: [
    ...
    { href: '/positions/journal',  label: 'Trade Journal', color: ACC,  icon: I.book },
    { href: '/positions/tax',      label: 'Tax / Cost-Basis', color: ACC, icon: I.scale },
    { href: '/positions/simulate', label: 'Pre-Trade Sim', color: ACC,  icon: I.scale },
    { href: '/backtest',           label: 'Backtest Lab',  color: PUR,  icon: I.signal },
    { href: '/account/connections', label: 'Connections',  color: ACC,  icon: I.user },
    { href: '/social',             label: 'KOL Feed',      color: MUTE, icon: I.news },
    { href: '/watchlist',          label: 'Symbol Watchlist', color: ACC, icon: I.watch },
    { href: '/trader-watch',       label: 'Tracked Traders', color: PUR, icon: I.user },
