...
export const PRESETS: Preset[] = [
  {
    ...
    layout: [
      { id: 'p0', type: 'market-pulse', w: 2, h: 1 },
      ...
      { id: 'p7', type: 'bounce-stats', w: 1, h: 1 },
    ],
  },
  {
    id: 'trader',
  ...
  },
  {
    id: 'whale-watcher',
    name: 'Whale Watcher',
    description: 'Track large positions, liquidations, rekt wallets & CVD',
    icon: <Eye className="w-3.5 h-3.5" />,
    layout: [
      { id: 'p1', type: 'btc-price', w: 1, h: 1 },
      { id: 'p2', type: 'liquidations', w: 1, h: 1 },
      { id: 'p3', type: 'bounce-stats', w: 1, h: 1 },
      { id: 'p4', type: 'long-short', w: 1, h: 1 },
      { id: 'p5', type: 'cvd', w: 2, h: 1 },
      { id: 'p6', type: 'oi-chart', w: 2, h: 1 },
      { id: 'p7', type: 'stablecoin-flows', w: 1, h: 1 },
      { id: 'p8', type: 'top-movers', w: 1, h: 1 },
      { id: 'p9', type: 'news', w: 1, h: 1 },
    ],
  },
  {
    id: 'macro-monitor',
