  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Calculate totals
        const volume = tickers.reduce((sum: number, t: TickerData) => sum + t.quoteVolume24h, 0);
        const oi = oiData.reduce((sum: number, o: OpenInterestData) => sum + o.openInterestValue, 0);
