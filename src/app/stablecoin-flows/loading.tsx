/**
 * Loading skeleton for /stablecoin-flows. Mirrors: hero + 4-cell +
 * chain distribution + weekly flows table.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function StablecoinFlowsLoading() {
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="text-white">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-6">
          ...
          <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] h-48 mb-4 animate-pulse" />
