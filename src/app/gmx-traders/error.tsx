...
export default function GMXTradersError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[GMX Traders] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">GMX Traders hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        Something broke loading the leaderboard — usually a transient GMX subgraph hiccup. Retry usually resolves it.
      </p>
