...
export default function FundingStats({ fundingRates, avgRate, highestRate, lowestRate }: FundingStatsProps) {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 mb-4 stagger-container">
      <div className="card-hub rounded-lg px-4 py-3 stagger-item">
      ...
      <div className="bg-[#111] border border-green-500/10 rounded-lg px-4 py-3 stagger-item">
      ...
      <div className="bg-[#111] border border-red-500/10 rounded-lg px-4 py-3 stagger-item">
