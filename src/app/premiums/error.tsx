...
export default function PremiumsError({
  ...
  useEffect(() => {
    console.error('[Premiums] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Premium feed hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        One of the regional venue APIs (Coinbase / Upbit / bitFlyer) may be temporarily unreachable. A retry usually resolves it.
      </p>
