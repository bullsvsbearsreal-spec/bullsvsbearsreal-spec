...
export default function PointsError({
  ...
  useEffect(() => {
    console.error('[Points Hub] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Points Hub hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        Something went wrong rendering the points directory. This page is mostly static so a retry should fix it.
      </p>
