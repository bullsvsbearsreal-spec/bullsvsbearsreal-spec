...
const ASSET_TABS: AssetTab[] = [
  ...
  },
  {
    ...
    pinned: [
      ...
      { label: 'Crude Oil', tvSymbol: 'NYMEX:CL1!', displayPair: '' },
      { label: 'Brent', tvSymbol: 'NYMEX:BB1!', displayPair: '' },
      { label: 'Natural Gas', tvSymbol: 'NYMEX:NG1!', displayPair: '' },
      { label: 'Copper', tvSymbol: 'COMEX:HG1!', displayPair: '' },
      { label: 'Platinum', tvSymbol: 'TVC:PLATINUM', displayPair: '' },
      { label: 'Palladium', tvSymbol: 'TVC:PALLADIUM', displayPair: '' },
      { label: 'Wheat', tvSymbol: 'CBOT:ZW1!', displayPair: '' },
      { label: 'Corn', tvSymbol: 'CBOT:ZC1!', displayPair: '' },
      { label: 'Soybeans', tvSymbol: 'CBOT:ZS1!', displayPair: '' },
      { label: 'Coffee', tvSymbol: 'NYMEX:KC1!', displayPair: '' },
      { label: 'Cocoa', tvSymbol: 'NYMEX:CC1!', displayPair: '' },
      { label: 'Sugar', tvSymbol: 'NYMEX:SB1!', displayPair: '' },
      { label: 'Cotton', tvSymbol: 'NYMEX:CT1!', displayPair: '' },
    ],
  },
  {
    id: 'indices',
