...
export const ASSET_TABS: AssetTab[] = [
  ...
  },
  {
    ...
    pinned: [
      ...
      // Crypto-correlated equities — high signal for this audience (miners
      // track BTC, COIN/MSTR are crypto proxies).
      { label: 'MARA', tvSymbol: 'NASDAQ:MARA', displayPair: '', cat: 'Crypto Equities' },
      { label: 'RIOT', tvSymbol: 'NASDAQ:RIOT', displayPair: '', cat: 'Crypto Equities' },
      { label: 'CLSK', tvSymbol: 'NASDAQ:CLSK', displayPair: '', cat: 'Crypto Equities' },
      { label: 'HOOD', tvSymbol: 'NASDAQ:HOOD', displayPair: '', cat: 'Crypto Equities' },
      { label: 'HUT', tvSymbol: 'NASDAQ:HUT', displayPair: '', cat: 'Crypto Equities' },
      { label: 'WULF', tvSymbol: 'NASDAQ:WULF', displayPair: '', cat: 'Crypto Equities' },
      { label: 'CIFR', tvSymbol: 'NASDAQ:CIFR', displayPair: '', cat: 'Crypto Equities' },
      { label: 'IREN', tvSymbol: 'NASDAQ:IREN', displayPair: '', cat: 'Crypto Equities' },
      { label: 'BITF', tvSymbol: 'NASDAQ:BITF', displayPair: '', cat: 'Crypto Equities' },
      // Mega-cap tech
      { label: 'AVGO', tvSymbol: 'NASDAQ:AVGO', displayPair: '', cat: 'Tech' },
      { label: 'ORCL', tvSymbol: 'NYSE:ORCL', displayPair: '', cat: 'Tech' },
      { label: 'CRM', tvSymbol: 'NYSE:CRM', displayPair: '', cat: 'Tech' },
      { label: 'ADBE', tvSymbol: 'NASDAQ:ADBE', displayPair: '', cat: 'Tech' },
      { label: 'INTC', tvSymbol: 'NASDAQ:INTC', displayPair: '', cat: 'Tech' },
      { label: 'QCOM', tvSymbol: 'NASDAQ:QCOM', displayPair: '', cat: 'Tech' },
      { label: 'MU', tvSymbol: 'NASDAQ:MU', displayPair: '', cat: 'Tech' },
      { label: 'UBER', tvSymbol: 'NYSE:UBER', displayPair: '', cat: 'Tech' },
      { label: 'ABNB', tvSymbol: 'NASDAQ:ABNB', displayPair: '', cat: 'Tech' },
      { label: 'SHOP', tvSymbol: 'NYSE:SHOP', displayPair: '', cat: 'Tech' },
      { label: 'NET', tvSymbol: 'NYSE:NET', displayPair: '', cat: 'Tech' },
      { label: 'SNOW', tvSymbol: 'NYSE:SNOW', displayPair: '', cat: 'Tech' },
      // Blue chip
      { label: 'COST', tvSymbol: 'NASDAQ:COST', displayPair: '', cat: 'Blue Chip' },
      { label: 'WMT', tvSymbol: 'NYSE:WMT', displayPair: '', cat: 'Blue Chip' },
      { label: 'XOM', tvSymbol: 'NYSE:XOM', displayPair: '', cat: 'Blue Chip' },
      { label: 'JNJ', tvSymbol: 'NYSE:JNJ', displayPair: '', cat: 'Blue Chip' },
      { label: 'KO', tvSymbol: 'NYSE:KO', displayPair: '', cat: 'Blue Chip' },
    ],
  },
  {
    id: 'forex',
    ...
    pinned: [
      ...
      { label: 'CAD/JPY', tvSymbol: 'FX:CADJPY', displayPair: '', cat: 'Crosses' },
      { label: 'CHF/JPY', tvSymbol: 'FX:CHFJPY', displayPair: '', cat: 'Crosses' },
      { label: 'NZD/JPY', tvSymbol: 'FX:NZDJPY', displayPair: '', cat: 'Crosses' },
      { label: 'EUR/CAD', tvSymbol: 'FX:EURCAD', displayPair: '', cat: 'Crosses' },
      { label: 'GBP/CAD', tvSymbol: 'FX:GBPCAD', displayPair: '', cat: 'Crosses' },
      { label: 'AUD/NZD', tvSymbol: 'FX:AUDNZD', displayPair: '', cat: 'Crosses' },
      { label: 'GBP/CHF', tvSymbol: 'FX:GBPCHF', displayPair: '', cat: 'Crosses' },
      { label: 'USD/SGD', tvSymbol: 'FX:USDSGD', displayPair: '', cat: 'EM' },
    ],
  },
  {
    id: 'commodities',
  ...
  },
  {
    ...
    pinned: [
      ...
      { label: 'IWM ETF', tvSymbol: 'AMEX:IWM', displayPair: '' },
      { label: 'DIA ETF', tvSymbol: 'AMEX:DIA', displayPair: '' },
      { label: 'VTI ETF', tvSymbol: 'AMEX:VTI', displayPair: '' },
    ],
  },
];
