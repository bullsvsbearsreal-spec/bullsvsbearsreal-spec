...
export default function AltseasonError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[Altseason] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Altseason feed hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        CoinGecko&apos;s free tier can rate-limit bursts. The index updates every 5 minutes — retry usually works.
      </p>
