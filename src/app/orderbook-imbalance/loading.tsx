/**
 * Loading skeleton for /orderbook-imbalance. Mirrors: hero + symbol +
 * imbalance gauge + per-symbol table.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function OrderbookImbalanceLoading() {
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] h-40 mb-4 animate-pulse" />
