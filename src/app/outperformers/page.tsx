      ...
      <main className="max-w-[1400px] mx-auto w-full px-4 py-6">
        <div className="mb-4">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            <h1 className="text-xl font-bold text-white">Altcoin Outperformance</h1>
          ...
          <p className="text-sm text-neutral-500">
            Which altcoins are beating BTC and ETH over the rolling window. Sort by vs-BTC, vs-ETH, or raw move.
          </p>
        </div>
