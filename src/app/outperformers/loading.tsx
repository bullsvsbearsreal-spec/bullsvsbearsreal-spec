/**
 * Loading skeleton for /outperformers. Mirrors: hero + benchmark
 * toggle + ranked table of altcoin outperformance.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function OutperformersLoading() {
  return (
