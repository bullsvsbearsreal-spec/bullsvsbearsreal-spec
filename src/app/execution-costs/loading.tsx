/**
 * Loading skeleton for /execution-costs. Mirrors: hero + size input +
 * venue-by-venue cost table.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function ExecutionCostsLoading() {
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        {/* Form card */}
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 mb-4 h-28 animate-pulse" />
