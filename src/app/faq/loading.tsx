  ...
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[1400px] mx-auto px-4 sm:px-6 py-5">
        ...
        {/* Search bar */}
        <div className="h-11 max-w-xl rounded-xl bg-white/[0.06] animate-pulse mb-8" />

        {/* 4 category sections, each with 3-5 stacked Q rows */}
        <div className="space-y-8">
          {Array.from({ length: 4 }).map((_, s) => (
            <section key={s}>
              <div className="h-4 w-40 bg-white/[0.06] rounded mb-1 animate-pulse" />
              <div className="h-3 w-72 max-w-full bg-white/[0.06] rounded mb-3 animate-pulse" />
