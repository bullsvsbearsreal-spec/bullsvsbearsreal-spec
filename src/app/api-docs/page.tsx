...
const FEATURES = [
  { icon: Zap, title: 'Real-time Data', desc: 'Funding rates, OI, and arbitrage opportunities refreshed every 60 seconds across 33 exchanges' },
  ...
  { icon: Database, title: '33 Exchanges', desc: 'CEX and DEX coverage — Binance, Bybit, OKX, Hyperliquid, dYdX, GMX, and more' },
];
...
export default function ApiDocsPage() {
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[900px] mx-auto px-4 sm:px-6">
        {/* Hero */}
        <section className="relative py-16 sm:py-24 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-neutral-500 text-sm sm:text-base max-w-xl mx-auto leading-relaxed mb-8">
              ...
              opportunities across 33 exchanges. Built for trading bots and dashboards.
            </p>
