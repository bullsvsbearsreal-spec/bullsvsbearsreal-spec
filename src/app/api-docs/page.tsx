...
const FEATURES = [
  { icon: Zap, title: 'Real-time Data', desc: 'Funding rates, OI, and arbitrage opportunities refreshed every 60 seconds across 24+ exchanges' },
        ...
        <section className="relative py-16 sm:py-24 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-neutral-500 text-sm sm:text-base max-w-xl mx-auto leading-relaxed mb-8">
              ...
              opportunities across 24+ exchanges. Built for trading bots and dashboards.
            </p>
