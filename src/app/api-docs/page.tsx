...
const ENDPOINT_GROUPS = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { path: '/api/v1/whale-liq', desc: 'Whale Liquidation Roulette — HL whale positions sorted by proximity to liq', icon: Flame },
...
const STEPS = [
  ...
  { num: '3', title: 'Start pulling data', desc: 'Make your first request. All 22 endpoints are ready.', icon: Play },
];
  ...
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[980px] mx-auto px-4 sm:px-6">
        ...
        <section className="relative py-16 sm:py-24 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-neutral-400 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-2">
              Real-time derivatives data from 32 exchanges, delivered through 22 REST endpoints.
            </p>
            ...
            <div className="inline-flex items-center gap-6 sm:gap-10 bg-white/[0.02] border border-white/[0.06] rounded-2xl px-8 py-5">
              ...
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-white font-mono"><AnimatedNumber target={22} /></div>
        ...
        <FadeIn className="mb-16">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-xl font-bold text-white">22 Endpoints</h2>
