  ...
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        {/* Gauge card */}
        <div className="bg-hub-darker border border-hub-subtle rounded-xl p-8 flex flex-col items-center mb-6">
          <div className="w-48 h-48 rounded-full bg-white/[0.06] animate-pulse mb-4" />
        ...
        <div className="bg-hub-darker border border-hub-subtle rounded-xl p-4">
          ...
          <div className="h-56 bg-white/[0.06] rounded-lg animate-pulse" />
        </div>
      </main>
    </div>
  );
