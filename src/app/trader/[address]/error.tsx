...
export default function TraderError({
  ...
  useEffect(() => {
    console.error('[Trader] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Trader profile hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        One of the venue fetches failed (GMX subgraph or HL API). The cross-platform view normally handles this
        gracefully — try again or browse from the leaderboards.
      </p>
