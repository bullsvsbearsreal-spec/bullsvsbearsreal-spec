/**
 * Loading skeleton for /bounce/leaderboard — rekt leaderboard.
 * Mirrors: hero + 4-cell + ranked list of wallets by rekt score.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function BounceLeaderboardLoading() {
  return (
