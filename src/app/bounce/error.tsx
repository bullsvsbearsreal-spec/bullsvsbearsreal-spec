...
export default function BounceError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[Bounce] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">bounce.tech feed hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        Either the upstream API is temporarily down or the address isn&apos;t indexed. Retry usually resolves it.
      </p>
