/**
 * Loading skeleton for /stablecoin-supply. Mirrors: hero + 4-cell +
 * total supply chart + per-stablecoin breakdown.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function StablecoinSupplyLoading() {
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[1200px] mx-auto px-4 py-6">
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] h-72 mb-4 animate-pulse" />
