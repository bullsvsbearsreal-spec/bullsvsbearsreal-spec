...
export default function ProtocolRevenueError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[Protocol Revenue] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Revenue feed hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        DeFiLlama&apos;s fees endpoint may be temporarily overloaded. A retry usually works within a few seconds.
      </p>
