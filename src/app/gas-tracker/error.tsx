...
export default function GasTrackerError({
  ...
  useEffect(() => {
    console.error('[Gas Tracker] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Gas feed hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        A public RPC endpoint may be overloaded. Gas data updates every 15 seconds — a retry almost always clears it.
      </p>
