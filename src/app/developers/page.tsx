...
const TERMINAL_LINES = [
  ...
  { type: 'json' as const, text: '    "shortExchange": "Bybit",' },
  { type: 'json' as const, text: '    "longExchange": "Hyperliquid",' },
  { type: 'json' as const, text: '    "grossSpread8h": 0.0219,' },
  { type: 'json' as const, text: '    "netSpread8h": 0.0019,' },
  { type: 'json' as const, text: '    "fees": { "roundTrip": 0.0200, "shortExchangeTaker": 0.0550 },' },
  { type: 'json' as const, text: '    "annualizedPct": 2.08,' },
  { type: 'json' as const, text: '    "grade": "A"' },
  { type: 'json' as const, text: '  }],' },
  { type: 'json' as const, text: '  "meta": { "feeModel": { "version": "v1.0-2026-02-01" } }' },
  { type: 'json' as const, text: '}' },
];
            ...
            {([
              {
                ...
                icon: Activity,
                desc: 'Automatically long on cheap exchanges, short on expensive ones. The /arbitrage endpoint returns net spread after round-trip fees, per-side maker/taker, and a feeModel version so your cached calcs stay in sync.',
              },
              {
