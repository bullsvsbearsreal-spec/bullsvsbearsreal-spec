...
const RainbowChartComponent = dynamic(() => import('./components/MarketCycleCharts').then(m => ({ default: m.RainbowChartComponent })), { ssr: false });
const WeeklyMAChart = dynamic(() => import('./components/MarketCycleCharts').then(m => ({ default: m.WeeklyMAChart })), { ssr: false });
