...
export default function RektError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[Rekt] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Rekt feed hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        bounce.tech&apos;s API may be temporarily unreachable. The leaderboard updates slowly so a retry almost always works.
      </p>
