/**
 * Loading skeleton for /rv-iv. Mirrors: hero + asset toggle +
 * RV vs IV chart + premium history.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function RvIvLoading() {
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[1200px] mx-auto px-4 py-6">
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] h-80 animate-pulse" />
      </main>
      <Footer />
    </div>
  );
