/**
 * Loading skeleton for /earnings-calendar. Mirrors: hero +
 * filter chips + week-grouped event list.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function EarningsCalendarLoading() {
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[1200px] mx-auto px-4 py-6">
        ...
        {/* Week-grouped event list */}
        <div className="space-y-4">
          {Array.from({ length: 3 }).map((_, week) => (
            <div key={week}>
              <div className="h-4 w-40 bg-white/[0.06] rounded mb-2 animate-pulse" />
