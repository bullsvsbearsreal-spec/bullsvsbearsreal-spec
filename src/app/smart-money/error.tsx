...
export default function SmartMoneyError({
  ...
  useEffect(() => {
    console.error('[Smart Money] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Smart Money scan hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        The aggregation across GMX + Hyperliquid leaderboards failed mid-fetch. This is usually a transient upstream hiccup.
      </p>
