      ...
      <main className="max-w-[1400px] mx-auto px-4 py-6">
          ...
          <div className="bg-hub-darker border border-white/[0.06] rounded-xl p-6">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="w-20 h-20 rounded-xl bg-hub-darker flex items-center justify-center border border-white/[0.06]">
                <img src="/icon-512.png" alt="InfoHub" className="w-16 h-16 object-contain" />
              </div>
              <div className="flex-1 text-center md:text-left">
                <h2 className="text-sm font-bold text-white mb-1">Download Logo Pack</h2>
                <p className="text-neutral-600 text-xs mb-3">Download logo in PNG format.</p>
                <a
                  href="/icon-512.png"
                  download
        ...
        <section className="mb-8">
          <h2 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
            <Image className="w-4 h-4 text-hub-yellow/70" />
            Logo
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white/[0.04] border border-white/[0.06] rounded-xl p-8">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="/infohub-logo.png" download className="flex items-center gap-2 px-4 py-2 rounded-xl bg-hub-yellow/10 text-hub-yellow text-sm font-medium hover:bg-hub-yellow/20 transition-colors">
                  <Download className="w-4 h-4" />
                  PNG
                </a>
              </div>
            ...
            <div className="bg-white/[0.04] border border-white/[0.06] rounded-xl p-8">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="/icon-512.png" download className="flex items-center gap-2 px-4 py-2 rounded-xl bg-hub-yellow/10 text-hub-yellow text-sm font-medium hover:bg-hub-yellow/20 transition-colors">
                  <Download className="w-4 h-4" />
                  PNG
                </a>
              </div>
        ...
        <section className="mb-8">
          <h2 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
            <Download className="w-4 h-4 text-hub-yellow/70" />
            All Assets
          </h2>
        ...
        <section className="mb-8">
          <h2 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
            <Palette className="w-4 h-4 text-hub-yellow/70" />
            Colors
          </h2>
        ...
        <section className="mb-8">
          <h2 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
            <Type className="w-4 h-4 text-hub-yellow/70" />
            Typography
          </h2>
        ...
        <section>
          <h2 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
            <Check className="w-4 h-4 text-hub-yellow/70" />
            Usage Guidelines
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-success/5 border border-success/20 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-neutral-600 text-sm">
                <li>Use logo on dark backgrounds</li>
                <li>Maintain clear space around the logo</li>
                <li>Scale proportionally</li>
                <li>Use provided PNG files for web</li>
              </ul>
            </div>
