/**
 * Loading skeleton for /fomc-playbook. Mirrors: hero + 4-cell +
 * historical FOMC events + market reaction timeline.
 */
import Header from '@/components/Header';
import Footer from '@/components/Footer';

export default function FomcPlaybookLoading() {
  return (
    <div className="min-h-screen bg-hub-black">
      ...
      <main id="main-content" className="max-w-[1200px] mx-auto px-4 py-6">
        ...
        {/* Upcoming FOMC card */}
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] h-28 mb-5 animate-pulse" />
