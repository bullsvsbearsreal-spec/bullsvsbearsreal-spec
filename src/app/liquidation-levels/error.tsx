...
export default function LiquidationLevelsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[Liquidation Levels] render error:', error);
  }, [error]);
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-lg font-semibold text-white mb-2">Liquidation scan hit an issue</h1>
      <p className="text-neutral-400 text-sm mb-6 max-w-sm">
        OKX's liquidation feed can CF-block Vercel regions occasionally. The DB fallback usually kicks in — retry or try a different symbol.
      </p>
