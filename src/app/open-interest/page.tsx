      ...
      <main className="max-w-[1400px] mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div className="bg-[#111] border border-white/[0.06] rounded-lg px-3 py-2.5">
            ...
            <div className="text-lg font-bold text-white font-mono mt-0.5">{formatValue(totalOI)}</div>
          </div>
          <div className="bg-[#111] border border-white/[0.06] rounded-lg px-3 py-2.5">
              ...
              .map(([exchange, value]) => {
                ...
                return (
                  <div key={exchange} className="text-center">
                    ...
                    <div className="text-sm font-bold text-white font-mono">{formatValue(value)}</div>
